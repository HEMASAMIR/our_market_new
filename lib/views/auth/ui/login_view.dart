...
import 'package:our_market_new_fixed/core/components/custom_circle_pro_ind.dart';
import 'package:our_market_new_fixed/core/functions/navigate_to.dart';
import 'package:our_market_new_fixed/core/functions/show_msg.dart';
import 'package:our_market_new_fixed/views/auth/logic/cubit/authentication_cubit.dart';
import 'package:our_market_new_fixed/views/auth/ui/forgot_view.dart';
import 'package:our_market_new_fixed/views/auth/ui/signup_view.dart';
import 'package:our_market_new_fixed/views/auth/ui/widgets/custom_row_with_arrow.dart';
import 'package:our_market_new_fixed/views/auth/ui/widgets/custom_text_btn.dart';
      ...
      listener: (context, state) {
        ...
        if (state is LoginLoading) {
          showDialog(
            ...
            builder: (_) => const Center(child: CustomCircleProgIndicator()),
          );
        }
      },
