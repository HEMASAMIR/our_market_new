...
import 'package:our_market_new_fixed/views/favorite/ui/favorite_view.dart';
import 'package:our_market_new_fixed/views/home/ui/home_view.dart';
import 'package:our_market_new_fixed/views/nav_bar/logic/cubit/nav_bar_cubit.dart';
import 'package:our_market_new_fixed/views/profile/ui/profile_view.dart';
import 'package:our_market_new_fixed/views/store/ui/store_view.dart';
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<NavBarCubit, NavBarState>(
        builder: (context, state) {
          ...
          return Scaffold(
            body: SafeArea(
              child: IndexedStack(index: cubit.currentIndex, children: views),
            ),
